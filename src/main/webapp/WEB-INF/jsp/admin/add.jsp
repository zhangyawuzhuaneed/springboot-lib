...
<body style="background: url(/resource/images/bg_1.jpg) ; background-size:100% 100% ; background-attachment: fixed">>
<div style="width: 1200px;margin: auto">
    ...
    --%>
    <form class="form-horizontal" action="${pageContext.request.contextPath}/admin/add" method="post">

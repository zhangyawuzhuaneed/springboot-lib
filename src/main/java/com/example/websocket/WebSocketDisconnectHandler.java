...
import com.example.enums.LoginTypeEnum;
import com.example.model.LoginInfoDo;
import com.example.model.ParticipantRepository;
...
public class WebSocketDisconnectHandler implements ApplicationListener<SessionDisconnectEvent> {
    ...
    public void onApplicationEvent(SessionDisconnectEvent sessionDisconnectEvent) {
        ...
        if (participantRepository.containsUserName(disconnectUserName)) {
            ...
            //保存登出信息
//            User userByName = (User)userService.getUserByName(removeUser.getName());
